                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
                            <div>
                                <h3 class="mb-1">Editar promoción</h3>
                                <p class="text-muted mb-0">Modifica los datos de la promoción y los productos asignados.</p>
                            </div>
                        ...
                        @if (session('conflicts'))
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                ...
                                <form method="POST" action="{{ route('discount.update', $discount->iddiscount) }}" class="mt-3">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    @if(old('products'))
                                        ...
                                        @endforeach
                                    @endif
                                    <button class="btn btn-danger">Confirmar reemplazo y actualizar promoción</button>
                        ...
                        <form method="POST" action="{{ route('discount.update', $discount->iddiscount) }}">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <input type="datetime-local" name="startdate" class="form-control" value="{{ old('startdate', \Carbon\Carbon::parse($discount->startdate)->format('Y-m-d\\TH:i') ) }}" required>
                                </div>
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Pre-populate old products from server-side selected or old()
            const oldProducts = @json(old('products', $selected ?? []));
